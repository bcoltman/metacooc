...
class Ingredients:
    def __init__(self, samples, taxa, presence_matrix, coverage_matrix):
...
# ingredients = Ingredients(samples, taxa, presence_matrix, coverage_matrix)
# these variables were generated in the old class like this
...
#saving object - is generated by the download scripts
# with open('ingredients.pkl', 'wb') as file:
    # pickle.dump(ingredients, file)

    
ingredients = pickle.load("data/ingredients.pkl")
