    ...
    *,
    ...
    if local_releases:
        suggestion = (
            ...
            f"--data_release {local_releases[0]}."
        )
    metadata_option = " --include_metadata" if file_kind == "metadata" else ""
    return (
        ...
        f"metacooc download --data_dir {data_dir} --data_release {data_release}"
        f"{metadata_option}"
    )
